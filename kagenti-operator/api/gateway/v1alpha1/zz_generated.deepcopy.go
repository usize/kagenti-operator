...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AIGatewayMTLS) DeepCopyInto(out *AIGatewayMTLS) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AIGatewayMTLS.
func (in *AIGatewayMTLS) DeepCopy() *AIGatewayMTLS {
	if in == nil {
		return nil
	}
	out := new(AIGatewayMTLS)
	in.DeepCopyInto(out)
	return out
}
